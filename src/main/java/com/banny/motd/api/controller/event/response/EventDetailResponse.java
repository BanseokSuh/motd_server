...
public class EventDetailResponse {
    ...
    @Builder
    private EventDetailResponse(Long id, String title, String imageUrl, String description, EventType eventType, int maxParticipants, LocalDateTime registerStartAt, LocalDateTime registerEndAt, LocalDateTime eventStartAt, LocalDateTime eventEndAt, RegisterUser registerUser) {
        this.id = id;
        this.title = title;
