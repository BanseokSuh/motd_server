...
public class EventListItemResponse {
    ...
    @Builder
    private EventListItemResponse(Long id, String title, String imageUrl, EventType eventType, int maxParticipants, List<Long> participantsIds, LocalDateTime registerStartAt, LocalDateTime registerEndAt, LocalDateTime eventStartAt, LocalDateTime eventEndAt, RegisterUser registerUser) {
        this.id = id;
        this.title = title;
